...
public class WinObject : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        animatorOfPanel = fadePanel.GetComponent<Animator>();     //패널 애니메이터 받아오기
        fadePanel.SetActive(true);

        isWin = 0;   
        isMoving = dog.GetComponent<RayScript>().isMoving;    //RayScript의 isMoving 가져온다. 멈췄을 때 dogLocation 받아온다.
    }
